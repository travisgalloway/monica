...
| DATA-7 | `test_stack_v2.py`, `test_ts_clean.py`, `test_ts_boundaries.py` | `test_build_ts_clean_corpus.py` | none | `resolve_tsc()`-gated real-tsc path | full 2–3B corpus build never run (#252) |
