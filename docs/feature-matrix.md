...
| CONF-2 | A person can prove MLX and CUDA agree numerically | done | done | done | n/a | In progress | #303 | design/03 |
...
| OPS-2 | A person gets every gate run automatically in CI | done | done | done | done | Shipped | #249 | design/06 |
